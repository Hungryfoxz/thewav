...
const Hero = () => {
  ...
  return (
    ...
    <div className='bg-[#080816] md:h-[120vh] h-[124vh] -z-10 relative overflow-hidden'>
      ...
      <div className='pt-28 flex flex-col justify-center items-center'>
        ...
        <div className='px-12 mt-5'>
          <h1 className='text-4xl md:text-5xl font-medium md:font-semibold text-white mb-4 text-center pb-2'>We help startups become brands</h1>
        </div>
      ...
      <div className='relative box-border'>
        ...
        <div className='mt-[6rem]'>
          <svg className='z-10' width="280" height="460" viewBox="0 0 208 432" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path d="M102.482 2.30545C103.28 1.37503 104.72 1.37503 105.518 2.30545L205.992 119.431C207.105 120.728 206.183 122.733 204.474 122.733L156.354 122.733C154.145 122.733 152.354 124.524 152.354 126.733L152.354 429C152.354 430.105 151.458 431 150.354 431L57.6462 431C56.5417 431 55.6462 430.105 55.6462 429L55.6462 126.733C55.6462 124.524 53.8554 122.733 51.6462 122.733L3.52606 122.733C1.81699 122.733 0.895304 120.728 2.00807 119.431L102.482 2.30545Z" fill="url(#paint0_linear_221_1127)" stroke="url(#paint1_linear_221_1127)" strokeWidth="2"/>
          <defs>
          <linearGradient id="paint0_linear_221_1127" x1="104" y1="-1.00001" x2="104" y2="302" gradientUnits="userSpaceOnUse">
          <stop stopColor="#000044"/>
          <stop offset="0.828548" stopColor="#080816"/>
          </linearGradient>
          <linearGradient id="paint1_linear_221_1127" x1="104" y1="-1" x2="104" y2="332" gradientUnits="userSpaceOnUse">
        ...
        <div className='absolute top-[3rem] right-[4.3rem]'>
          <svg className='-z-10' width="60" height="74" viewBox="0 0 60 74" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <div className='absolute top-[10.7rem] left-[1rem]'>
        <svg className='-z-10' width="44" height="56" viewBox="0 0 44 56" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <div className='absolute top-[12rem] right-[1rem]'>
        ...
        <div className='absolute top-64 lg:top-[21.2rem] left-[3.7rem]'>
        ...
        <div className='absolute top-64 lg:top-[20rem] right-[3rem]'>
        ...
        <div className='hidden lg:block absolute top-[36vh] z-[100] left-[3.48rem]'>
          {/* <div className='flex items-center justify-center box-border'> */}
            <button className='relative bg-[#0049FA] hover:bg-white text-white rounded px-7 py-3 font-normal text-base flex flex-row items-center justify-center cursor-pointer'>
              <svg className='pr-2 hidden' width="18" height="19" viewBox="0 0 18 19" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path d="M8.76562 1.14062L7.98438 1.88281C7.78906 2.07812 7.78906 2.39062 7.98438 2.54688L14.0391 8.60156H0.71875C0.445312 8.60156 0.25 8.83594 0.25 9.07031V10.1641C0.25 10.4375 0.445312 10.6328 0.71875 10.6328H14.0391L7.98438 16.7266C7.78906 16.8828 7.78906 17.1953 7.98438 17.3906L8.76562 18.1328C8.92188 18.3281 9.23438 18.3281 9.42969 18.1328L17.5938 9.96875C17.7891 9.77344 17.7891 9.5 17.5938 9.30469L9.42969 1.14062C9.23438 0.945312 8.92188 0.945312 8.76562 1.14062Z" fill="#0049FA"/>
              </svg>
                Get in Touch
      ...
      <div className='w-[100vw] absolute bottom-0'>
        ...
        <div className='w-[105vw] relative'>
          {/* Large screen */}
          <svg className='-mb-20 hidden md:block' width="1920" height="340" viewBox="0 0 1920 283" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <div className='hidden md:block absolute top-[5rem] w-[100vw]'>
            ...
            <div className='flex flex-col my-2 mx-24'>
          ...
          <div className='md:hidden absolute top-28 w-[100vw] z-10'>
            {/* Two lines of logos for large screen is divided into two rows. */}
            <div className='flex flex-col my-1 mx-6 mb-1 md:mx-16'>
              {/* Six logos will come in here for large screen. */}
    ...
    {/* ============================================================================ */}
      ...
      <div className='flex flex-row mt-20 mb-10'>
        ...
        {/* Customer Review */}
        <div className='flex flex-col w-[55vw] ml-10'>
          {/* Lorem ipsum.... */}
        ...
        <div className='min-w-[6vw] mr-[8rem] flex items-end justify-between pb-4'>
...
// *?Navbar Custom.      
  //  <div className='absolute h-[96px] left-0 right-0 top-0'> 
  // <div className='text-white flex flex-row justify-between my-5 md:mx-16 mx-8'>

  //       {/*  Left Section <<<<<<<<< */}
  //       {/* ###################### Logo is Here...##################### */}
  //       {/* Desktop view */}
  //       <div >
  //           <svg className='hidden md:block h-10 w-28' width="144" height="43" viewBox="0 0 144 43" fill="none" xmlns="http://www.w3.org/2000/svg">
  ...
  //           <svg className='md:hidden' width="75" height="18" viewBox="0 0 75 18" fill="none" xmlns="http://www.w3.org/2000/svg">
  //           <path d="M2.9184 3.0416L2.3424 5.48H0.6336V7.7456H2.3424V13.0448C2.3424 15.8672 3.4944 17 6.24 17H7.2384V14.6192H6.4704C5.28 14.6192 4.7424 14.1008 4.7424 12.9104V7.7456H7.2384V5.48H4.7424V3.0416H2.9184ZM16.6836 11.2208V17H19.0836V11.2208C19.0836 7.6688 17.2404 5.3456 14.322 5.3456C12.9012 5.3456 11.634 6.1904 11.1924 7.3616V0.68H8.79236V17H11.1924V11.24C11.1924 9.2048 12.3444 7.7456 13.8996 7.7456C15.5892 7.7456 16.6836 9.1088 16.6836 11.2208ZM29.0865 13.4672C28.6449 14.2736 27.6849 14.8304 26.4945 14.8304C24.8625 14.8304 23.6337 13.736 23.3265 12.0656H31.9857C32.0433 11.7776 32.0625 11.4512 32.0625 11.144C32.0625 7.8416 29.6241 5.3264 26.4561 5.3264C23.2689 5.3264 20.8497 7.8608 20.8497 11.2016C20.8497 14.6576 23.1921 17.096 26.5137 17.096C28.8177 17.096 30.8529 15.6176 31.6401 13.4672H29.0865ZM23.3265 10.3184C23.6529 8.6864 24.8625 7.592 26.4561 7.592C28.0497 7.592 29.2785 8.7056 29.5857 10.3184H23.3265ZM38.9525 17L41.2949 9.4928L43.6373 17H46.1525L49.7429 5.48H47.2277L44.8853 12.9872L42.5429 5.48H40.0469L37.7045 12.9872L35.3621 5.48H32.8469L36.4565 17H38.9525ZM59.6097 17H62.0097V5.48H59.6097V7.3616C59.1105 6.1712 57.5361 5.3456 55.9425 5.3456C52.6017 5.3456 50.4513 7.688 50.4513 11.2208C50.4513 14.7728 52.6209 17.1152 55.9425 17.1152C57.5553 17.1152 59.1105 16.2896 59.6097 15.1184V17ZM52.8513 11.2208C52.8513 9.128 54.2145 7.7456 56.2305 7.7456C58.1889 7.7456 59.6097 9.1856 59.6097 11.24C59.6289 13.3136 58.2465 14.7152 56.2497 14.7152C54.2337 14.7152 52.8513 13.3328 52.8513 11.2208ZM70.4259 17L74.8995 5.48H72.3459L69.1587 13.6976L65.9715 5.48H63.4179L67.8723 17H70.4259Z" fill="white"/>
  //           </svg>
  //       </div>  
  ...
  //           <div className='border-2 items-center justify-center px-4 text-base font-light rounded-sm mr-12 hidden md:block'>
  //               <p className='px-1 py-2 subpixel-antialiased'>Get A Free Audit </p>
  //           </div>

  //           {/* ##########################   Menu bars  ###########################  */}
  //           <div className='items-center justify-items-center flex h-8 w-8 mr-4'>
  //               <svg className='p-1 md:p-0 md:mt-2' width="46" height="26" viewBox="0 0 46 26" fill="none" xmlns="http://www.w3.org/2000/svg">
