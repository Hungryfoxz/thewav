  ...
  return (
    <form className="lg:px-[2rem]" action="#">
        ...
        <div className="hidden lg:block text-white pt-[3rem]">
            <button className="w-[14rem] group text-base flex flex-row items-center transition-all hover:bg-white hover:text-[#0049FA] bg-[#0049FA] py-4 px-5 rounded-sm overflow-hidden">
                <svg className='mr-2 transition-all -translate-x-6 group-hover:translate-x-4' width="16" height="16" viewBox="0 0 18 19" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <span className="transform group-hover:translate-x-4 duration-100 group-hover:font-medium">
                Get Free Audit
                </span>
                <svg className="ml-2 transition-all group-hover:translate-x-7" width="16" height="16" viewBox="0 0 21 22" fill="none" xmlns="http://www.w3.org/2000/svg">
